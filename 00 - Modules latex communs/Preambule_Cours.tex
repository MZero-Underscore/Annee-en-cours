...
% --- DÉFINITIONS (Bleu) ---
% Usage : \begin{definition}            -> "Définition 1"
%         \begin{definition}[Mon titre] -> "Définition 1 - Mon titre"
\newtcolorbox{definition}[1][]{breakable,colback=white!6!white,colframe=blue!85!white,fonttitle=\bfseries,title={Définition \thedfn\ifx&#1&\else\ - #1\fi}, code={\stepcounter{dfn}}, arc=3mm}

% --- PROPRIÉTÉS & THÉORÈMES (Rouge/Orange) ---
% Usage : \begin{theoreme}            -> "Théorème 1"
%         \begin{theoreme}[Mon titre] -> "Théorème 1 - Mon titre"
\newtcolorbox{theoreme}[1][]{breakable,colback=red!6!white,colframe=red!85!white,fonttitle=\bfseries,title={Théorème \thethm\ifx&#1&\else\ - #1\fi}, code={\stepcounter{thm}}, arc=3mm}
% Usage : \begin{propriete}            -> "Propriété 1"
%         \begin{propriete}[Mon titre] -> "Propriété 1 - Mon titre"
\newtcolorbox{propriete}[1][]{breakable,colback=red!6!white,colframe=red!85!white,fonttitle=\bfseries,title={Propriété \theprp\ifx&#1&\else\ - #1\fi}, code={\stepcounter{prp}}, arc=3mm}
...
% --- REMARQUES (Orange) ---
% Usage : \begin{remarque}            -> "Remarque 1"
%         \begin{remarque}[Mon titre] -> "Remarque 1 - Mon titre"
\newtcolorbox{remarque}[1][]{enhanced, breakable, frame empty, nobeforeafter, borderline west={0.5mm}{0mm}{orange!85!white}, title={Remarque \therq\ifx&#1&\else\ - #1\fi}, colback=white, code={\stepcounter{rq}}, attach boxed title to top left = {xshift = -3mm}, boxed title style={size=small,colback=orange!85!white,colframe=orange!85!white, arc=3mm}}

% --- MÉTHODES & APPLICATIONS (Bleu foncé) ---
% Usage : \begin{methode}            -> "Méthode 1"
%         \begin{methode}[Mon titre] -> "Méthode 1 - Mon titre"
\newtcolorbox{methode}[1][]{enhanced, breakable, frame empty, nobeforeafter, borderline west={0.5mm}{0mm}{blue!75!black}, title={Méthode \themtd\ifx&#1&\else\ - #1\fi}, colback=white, code={\stepcounter{mtd}}, attach boxed title to top left = {xshift = -3mm}, boxed title style={size=small,colback=blue!75!black,colframe=blue!75!black, arc=3mm}}
...
% Usage : \begin{exercice}            -> "Exercice n°1"
%         \begin{exercice}[Mon titre] -> "Exercice n°1 - Mon titre"
\newtcolorbox{exercice}[1][]{enhanced, breakable, frame empty, nobeforeafter, borderline west={0.5mm}{0mm}{green!55!black}, title={Exercice n°\theexo\ifx&#1&\else\ - #1\fi}, colback=white, code={\stepcounter{exo}}, attach boxed title to top left = {xshift = -3mm}, boxed title style={size=small,colback=green!55!black,colframe=green!55!black, arc=3mm}}
...
\newcommand{\enteteActivite}[3]{%
    \noindent
    \begin{tabularx}{\textwidth}{@{}p{2.5cm} >{\centering\arraybackslash}X p{2.5cm}@{}}
