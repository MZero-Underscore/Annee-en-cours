...
\thispagestyle{fancy}
    ...
    \begin{exerciceTitre}{Le test du diagramme}
...
\section{La machine à calculer}
    ...
    \begin{exerciceTitre}{Fonctionnement interne}
...
\section{Lecture graphique (Le "Montagnes Russes")}
    ...
    \begin{exerciceTitre}{Analyse d'une courbe}
...
\section{Notations et Vocabulaire}
    ...
    \begin{exerciceTitre}{Le jeu des traductions}
...
\newpage
    ...
    \begin{exerciceTitre}{Vrai ou Faux ?}
    ...
    \begin{exerciceTitre}{Le sens inverse}
    ...
    \begin{methodeTitre}{Calculer une image par une formule}
